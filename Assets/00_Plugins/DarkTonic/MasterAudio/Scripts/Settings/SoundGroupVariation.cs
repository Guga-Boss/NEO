...
namespace DarkTonic.MasterAudio {
    ...
    public class SoundGroupVariation : MonoBehaviour {
        ...
        private void Awake() {
            ...
            if (c != null || g != null) {
            } // to disable the warning for not using it.
    ...
    public void SetSpatialBlend() {
        ...
        public void LoadInternetFile() {
            //ggStartCoroutine(AudioResourceOptimizer.PopulateSourceWithInternetFile(internetFileUrl, this, InternetFileLoaded, InternetFileFailedToLoad));
        }
