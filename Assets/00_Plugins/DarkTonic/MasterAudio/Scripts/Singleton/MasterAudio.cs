    ...
    public class MasterAudio : MonoBehaviour {
        ...
        private void Awake() {
            ...
            for (var k = 0; k < Trans.childCount; k++) {
                ...
                AudioSourcesBySoundType.Add(soundType, group);
        ...
        public static void PlaySoundAndForget(string sType, float volumePercentage = 1f, float? pitch = null,
        ...
        /// <param name="delaySoundTime"><b>Optional</b> - used if you want to play the sound X seconds from now instead of immediately.</param>
        /// <param name="variationName"><b>Optional</b> - used if you want to play a specific variation by name. Otherwise a random variation is played.</param>
        public static void PlaySound3DAtVector3AndForget(string sType, Vector3 sourcePosition,
            ...
            PlaySoundAtVolume(sType, volumePercentage, sourcePosition, pitch, null, variationName, false, delaySoundTime,
                true);
        }
        ...
        /// <param name="delaySoundTime"><b>Optional</b> - used if you want to play the sound X seconds from now instead of immediately.</param>
        /// <param name="variationName"><b>Optional</b> - used if you want to play a specific variation by name. Otherwise a random variation is played.</param>
        public static void PlaySound3DAtTransformAndForget(string sType, Transform sourceTrans = null,
            float volumePercentage = 1f, float? pitch = null, float delaySoundTime = 0f, string variationName = null) {
            if (!SceneHasMasterAudio) {
                return;
            }
            ...
            PlaySoundAtVolume(sType, volumePercentage, Vector3.zero, pitch, sourceTrans, variationName, false,
                delaySoundTime);
        }
        ...
        /// <param name="delaySoundTime"><b>Optional</b> - used if you want to play the sound X seconds from now instead of immediately.</param>
        /// <param name="variationName"><b>Optional</b> - used if you want to play a specific variation by name. Otherwise a random variation is played.</param>
        public static void PlaySound3DFollowTransformAndForget(string sType, Transform sourceTrans = null,
            float volumePercentage = 1f, float? pitch = null, float delaySoundTime = 0f, string variationName = null) {
            if (!SceneHasMasterAudio) {
                return;
            }
            ...
            PlaySoundAtVolume(sType, volumePercentage, Vector3.zero, pitch, sourceTrans, variationName, true,
                delaySoundTime);
        }
        ...
        /// <param name="delaySoundTime"><b>Optional</b> - used if you want to play the sound X seconds from now instead of immediately.</param>
        /// <param name="variationName"><b>Optional</b> - used if you want to play a specific variation by name. Otherwise a random variation is played.</param>
        public static void PlaySound3DAndForget(string sType, Transform sourceTrans = null, bool attachToSource = false,
            float volumePercentage = 1f, float? pitch = null, float delaySoundTime = 0f, string variationName = null) {
            if (!SceneHasMasterAudio) {
                return;
            }
            ...
            PlaySoundAtVolume(sType, volumePercentage, Vector3.zero, pitch, sourceTrans, variationName, attachToSource,
                delaySoundTime);
        }
                ...
                switch (maGroup.limitMode) {
                    case MasterAudioGroup.LimitMode.TimeBased:
                        if (maGroup.minimumTimeBetween > 0) {
                            ...
                            group.LastTimePlayed = Time.realtimeSinceStartup;
                        }
                        break;
                    case MasterAudioGroup.LimitMode.FrameBased:
                        ...
                        group.LastFramePlayed = Time.frameCount;
        ...
        private static void RemoveClipAndRefillIfEmpty(AudioGroupInfo grp, bool isNonSpecific, int? randomIndex,
            List<int> choices, string sType, int pickedChoice, bool loggingEnabledForGrp) {
        ...
        public static void TriggerParticleEmission(Transform trans, int particleCount) {
            var part = trans.GetComponent<ParticleSystem>();
            if (part == null) {
                return;
            }
        ...
        public static List<GameObject> GetAllPlayingVariationsInBus(string busName) {
            var playingVars = new List<GameObject>(32);
            ...
            while (sources.MoveNext()) {
                ...
                for (var i = 0; i < aInfo.Sources.Count; i++) {
                    ...
                    playingVars.Add(aVar.gameObject);
                }
            }
        ...
        public static void DeleteBus(int busIndex) {
            ...
            while (sources.MoveNext()) {
                aGroup = sources.Current.Value.Group;
...
#if UNITY_5
                    Instance.RouteGroupToUnityMixerGroup(aGroup.name, null);
#endif
        ...
        public static void ReDownloadAllInternetFiles() {
            ...
            foreach (var key in AudioSourcesBySoundType.Keys) {
                ...
                for (var i = 0; i < AudioSourcesBySoundType[key].Sources.Count; i++) {
                    ...
                    //ggAudioResourceOptimizer.RemoveLoadedInternetClip(aVar.internetFileUrl);
        ...
        public static Transform AudioListenerTransform {
            get {
                ...
                _audListenerTrans = audListener == null ? null : audListener.transform;
        ...
        public MixerWidthMode MixerWidth {
            get {
                if (!PlayerPrefs.HasKey(MixerWidthSettingKey)) {
                    PlayerPrefs.SetString(MixerWidthSettingKey, MixerWidthMode.Narrow.ToString());
                }

                var mode = MixerWidthMode.Narrow;
                if (!string.IsNullOrEmpty(PlayerPrefs.GetString(MixerWidthSettingKey))) {
                    mode = (MixerWidthMode) Enum.Parse(typeof(MixerWidthMode), PlayerPrefs.GetString(MixerWidthSettingKey));
                }

                return mode;
            }
            set {
                PlayerPrefs.SetString(MixerWidthSettingKey, value.ToString());
            }
        }
        /*! \endcond */
        ...
        public float DuckedVolumeMultiplier {
            get { return duckedVolumeMultiplier; }
            set {
        ...
        public List<string> GroupNames {
            get {
                var groupNames = new List<string> { DynamicGroupName, NoGroupName };
        ...
        public List<string> PlaylistNames {
            get {
                var playlistNames = new List<string> { DynamicGroupName, NoGroupName };
        ...
        public List<string> CustomEventNames {
            get {
                var customEventNames = new List<string> { DynamicGroupName, NoGroupName };
        ...
        public static bool UseDbScaleForVolume {
            get {
                if (!PlayerPrefs.HasKey(UseDbKey)) {
                    PlayerPrefs.SetInt(UseDbKey, 0);
                }

                return PlayerPrefs.GetInt(UseDbKey) > 0;
            }
            set { PlayerPrefs.SetInt(UseDbKey, value ? 1 : 0); }
        }

        public static bool UseCentsForPitch {
            get {
                if (!PlayerPrefs.HasKey(UseCentsPitchKey)) {
                    PlayerPrefs.SetInt(UseCentsPitchKey, 0);
                }

                return PlayerPrefs.GetInt(UseCentsPitchKey) > 0;
            }
            set { PlayerPrefs.SetInt(UseCentsPitchKey, value ? 1 : 0); }
        }

        public static bool HideLogoNav {
            get {
                if (!PlayerPrefs.HasKey(HideLogoNavKey)) {
                    PlayerPrefs.SetInt(HideLogoNavKey, 0);
                }

                return PlayerPrefs.GetInt(HideLogoNavKey) > 0;
            }
            set { PlayerPrefs.SetInt(HideLogoNavKey, value ? 1 : 0); }
        }
...
#if UNITY_4_5_3 || UNITY_4_5_4 || UNITY_4_5_5 || UNITY_4_6 || UNITY_5
        ...
        public static string MasterAudioFolderPath {
            get {
                if (!PlayerPrefs.HasKey(InstallationFolderKey)) {
                    PlayerPrefs.SetString(InstallationFolderKey, MasterAudioDefaultFolder);
                }

                return PlayerPrefs.GetString(InstallationFolderKey);
            }
            set {
                PlayerPrefs.SetString(InstallationFolderKey, value);
            }
        }
        ...
        public static GameObject CreateMasterAudio() {
            ...
            var ma = AssetDatabase.LoadAssetAtPath(MasterAudioFolderPath + "/Prefabs/MasterAudio.prefab",
                typeof(GameObject));
#else
        var ma = Resources.Load(MasterAudioFolderPath + "/Prefabs/MasterAudio.prefab", typeof(GameObject));
#endif
            if (ma == null) {
                Debug.LogError(
        ...
        public static GameObject CreatePlaylistController() {
            ...
            var pc = AssetDatabase.LoadAssetAtPath(MasterAudioFolderPath + "/Prefabs/PlaylistController.prefab",
                typeof(GameObject));
#else
        var pc = Resources.Load(MasterAudioFolderPath + "/Prefabs/PlaylistController.prefab", typeof(GameObject));
#endif
            if (pc == null) {
                Debug.LogError(
        ...
        public static GameObject CreateDynamicSoundGroupCreator() {
            ...
            var pc = AssetDatabase.LoadAssetAtPath(MasterAudioFolderPath + "/Prefabs/DynamicSoundGroupCreator.prefab",
                typeof(GameObject));
#else
        var pc = Resources.Load(MasterAudioFolderPath + "/Prefabs/DynamicSoundGroupCreator.prefab", typeof(GameObject));
#endif
            if (pc == null) {
                Debug.LogError(
        ...
        public static GameObject CreateSoundGroupOrganizer() {
            ...
            var pc = AssetDatabase.LoadAssetAtPath(MasterAudioFolderPath + "/Prefabs/SoundGroupOrganizer.prefab",
                typeof(GameObject));
#else
        var pc = Resources.Load(MasterAudioFolderPath + "/Prefabs/SoundGroupOrganizer.prefab", typeof(GameObject));
#endif
            if (pc == null) {
                Debug.LogError(
