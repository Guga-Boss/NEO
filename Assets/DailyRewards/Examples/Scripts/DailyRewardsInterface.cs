...
namespace NiobiumStudios
{
    ...
    public class DailyRewardsInterface : MonoBehaviour
    {
		...
		public DailyRewards dailyRewards;			// DailyReward Instance      
        ...
        public void UpdateUI()
        {
            ...
            var lastReward = dailyRewards.RewardID;
        ...
        public void SnapToReward()
        {
            ...
            var lastRewardIdx = dailyRewards.RewardID;
        ...
        private void OnClaimPrize(int day)
        {
            ...
            var reward = dailyRewards.GetReward(day);
            var unit = reward.Item;
            var rewardQt = reward.RewardAmt;
            //imageReward.sprite = reward.sprite;
            if (rewardQt > 0)
            {
                textReward.text = string.Format("You got {0} {1}!", reward.RewardAmt, unit);
            }
            else
            {
