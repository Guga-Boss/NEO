...
namespace NiobiumStudios
{
    ...
    **/
    public static class CloudClockBuilder
    {
        ...
        public static int connectionRetries;                          // Retries counter
        ...
        public static IEnumerator InitializeCloudClock(List<CloudClock> cloudClockList, int maxRetries)
        {
            ...
            foreach (var cloudClock in cloudClockList)
            {
                ...
                while (connectionRetries < maxRetries)
                {
                    ...
                    {
                        // old: connectionRetries++;
                        if( ++connectionRetries == 6 ) connectionRetries = 1;
                        Manager.I.ConnectionRetries = connectionRetries;
                ...
                {
                    Debug.Log("Error Loading Cloud Clock: " + cloudClock.url + " Error:" + errorMessage);
