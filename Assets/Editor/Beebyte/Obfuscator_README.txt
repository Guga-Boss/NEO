Obfuscator v3.0.1 Copyright (c) 2015-2020 Beebyte Limited. All Rights Reserved
...
The obfuscator is designed to work out of the box. When you build your project it automatically replaces the Assembly-CSharp.dll 
with an obfuscated version. If you use assembly definitions then these too will be obfuscated by default.
...
======================================================================================
    ...
    * Photon Networking
      Add 'ExitGames' to the list of Skipped Namespaces if it's not already declared there.
      ...
      For convenience the default settings have been updated to include the list of enums to skip:
