...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        public LightningBoltScript Lighting2 = null;
        ...
        {
            GameObject ob = null;
            if( Lighting2 != null ) ob = Lighting2.gameObject;            
            if( ob && PoolManager.Pools[ "Pool" ].IsSpawned( ob.transform ) )
                PoolManager.Pools[ "Pool" ].Despawn( ob.transform );
