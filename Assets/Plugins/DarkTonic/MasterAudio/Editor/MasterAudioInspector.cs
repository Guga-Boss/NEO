...
public class MasterAudioInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (plControllerInScene) {
            ...
            var newCrossTime = GUILayout.HorizontalSlider(_sounds.crossFadeTime, 0f, 10f, GUILayout.Width(width));
        ...
        if (_sounds.areGroupsExpanded) {
            ...
            if (groups.Count == 0) {
                ...
                for (var l = 0; l < filteredGroups.Count; l++) {
                    ...
                    groupButtonPressed = DTGUIHelper.AddMixerButtons(aGroup, "Group", true);
        ...
        if (_sounds.playListExpanded) {
            ...
            if (!plControllerInScene) {
                ...
                for (var i = 0; i < pcs.Count; i++) {
                    ...
                    var buttonPressed = DTGUIHelper.AddPlaylistControllerSetupButtons(controller, "Playlist Controller", false, false);
