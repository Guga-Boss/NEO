...
public class FragmentSpawner : MonoBehaviour {
	...
	protected virtual GameObject CreateNewFragmentContainer()
	{
		...
		//v_newParent.transform.rotation = this.transform.rotation;
		AlphaScheduler v_scheduler = v_newParent.AddComponent<AlphaScheduler>();
		...
		v_scheduler.DestroyOptionWhenStop = WhenStopDestroyEnum.DestroyGameObject;
		v_scheduler.MaxTime = m_lifeTime;
		v_scheduler.InitialDelay = 0.5f;
